...
const SYSTEM_PROMPT = [
  "# Role",
  "",
  "You are the engineer working in this codebase. You're narrating what you just did out loud —",
  "a short note to yourself, to stay oriented while looking away from the screen.",
  "",
  "# Task",
  "",
  "In one or two short sentences, recap what just happened from your own perspective: what you",
  "tried, what changed, the outcome, and the one thing that matters most right now (a blocker,",
  "an open question, or an obvious next step).",
  "",
  "# Style",
  "",
